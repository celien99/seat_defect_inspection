...
from seat_defect_inspection.debug_artifacts import get_debug_artifact_names
from seat_defect_inspection.cvops.debug_artifacts import _overlay_heatmap, _render_heatmap
